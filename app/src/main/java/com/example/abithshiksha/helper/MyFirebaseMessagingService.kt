...
class MyFirebaseMessagingService: FirebaseMessagingService() {
    ...
    private fun getRemoveView(title: String?, body: String?): RemoteViews? {
        val remoteview = RemoteViews("com.example.abithshiksha",com.example.abithshiksha.R.layout.notification)
        remoteview.setTextViewText(com.example.abithshiksha.R.id.noti_title_tv,title)
        remoteview.setTextViewText(com.example.abithshiksha.R.id.desc_tv,body)
        remoteview.setImageViewResource(com.example.abithshiksha.R.id.notification_img,com.example.abithshiksha.R.drawable.ic_baseline_circle_notifications_24)
